...
| Mission ID | Mission Statement/Stakeholder Requirements | Time at which Non Pr Materials Exhuasted | MTBF | MTTR | MDT | Aoss | Collection Capacity | Assembling Capacity | Printing Capacity | Total Robots | Average Build Quality of System | Total |
| ---------- | ------------------------------------------ | ---------------------------------------- | ---- | ---- | --- | ---- | ------------------- | ------------------- | ----------------- | ------------ | ------------------------------- | ----- |
