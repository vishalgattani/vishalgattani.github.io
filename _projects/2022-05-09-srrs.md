...
| Mission ID | Non Pr Materials Exhausted (t) | MTBF | MTTR | MDT | Aoss | Collection Capacity | Assembling Capacity | Printing Capacity | Total Robots | Average Build Quality of System | Total |
|------------|--------------------------------|------|------|-----|------|---------------------|---------------------|-------------------|--------------|---------------------------------|-------|
