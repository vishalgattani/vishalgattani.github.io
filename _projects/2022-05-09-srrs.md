...
$$
Robot Quality \leftarrow Assembler\/Replicator Quality
$$
...
if rand > (1.0 − Quality\_incr\_Chance):
  RobotQuality \leftarrow AssemblerQuality + random(Quality\_incr\_Lower, Quality\_incr\_Upper)
else if rand < Quality_decr_Chance:
  RobotQuality \leftarrow AssemblerQuality − random(Quality\_decr\_Lower, Quality\_decr\_Upper)
else:
  RobotQuality \leftarrow AssemblerQuality
$$
...
$$
if robot.getNumTasksRemainingBeforeFailure() \rightarrow 0:
    robot.taskFail()
    repairing(robot)
else:
...
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/106.embed"></iframe>
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/108.embed"></iframe>

<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/110.embed"></iframe>
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/112.embed"></iframe>

<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/114.embed"></iframe>
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/116.embed"></iframe>

<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/118.embed"></iframe>
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/120.embed"></iframe>

<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/122.embed"></iframe>
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/124.embed"></iframe>

<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~vishalgattani/126.embed"></iframe>
